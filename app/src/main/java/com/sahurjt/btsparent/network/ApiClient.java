...
public class ApiClient {
    private static final String API_BASE_URL = "http://192.168.43.155:5000/api/v1/parent/";
    //private static final String API_BASE_URL = "http://sahurjt.pythonanywhere.com/api/v1/parent/";
    public static final String API_IMAGE_KID_BASE_URL="http://192.168.43.155:5000/api/v1/parent/photo_kid?";
